...
import aboutImg from '../assets/tajwar.jpg'   // 👈 image import
      ...
      <section className="min-h-screen bg-blue-900 flex flex-col md:flex-row items-center justify-between text-white p-6 md:p-10 gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="mb-4 text-gray-200">
            ...
            illum, dolorem, obcaecati eos debitis fuga officiis vitae eligendi
            optio animi labore exercitationem odio pariatur culpa velit vel hic
            quis.
          </p>

          <p className="text-gray-200">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            Perspiciatis quia placeat sapiente vel corporis, laboriosam ad
            blanditiis natus excepturi officia, repellat sunt consequatur.
          </p>
        </div>
      </section>
    </>
